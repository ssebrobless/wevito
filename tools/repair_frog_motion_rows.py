#!/usr/bin/env python3
"""Clean frog runtime rows by reseeding from local idle silhouettes.

This removes stacked/ghosted frog action art while preserving each row's
existing frog design. It is a conservative runtime cleanup, not a bespoke
extended-leg leap authoring pass.
"""
...
MOTION_PATTERNS = {
    ...
    "walk": [(-2, 0), (1, -2), (4, -5), (5, -3), (3, 0), (0, 1)],
    "eat": [(0, 0), (1, 0), (0, 1), (1, 0)],
    "happy": [(0, 0), (0, -3), (0, -6), (0, -3)],
    "sad": [(0, 1), (0, 2)],
    "sleep": [(0, 1), (0, 2)],
...
def main() -> int:
    ...
    (args.output_root / "frog-motion-cleanup.json").write_text(json.dumps(payload, indent=2), encoding="utf-8")
    write_markdown(args.output_root / "frog-motion-cleanup.md", payload)
