...
public sealed class PlainLanguageExplainer
{
    ...
    [
        ...
        SelfImprovementPacketKinds.MutationScopeAuditEvent,
    ...
    public string ExplainPacketKind(string packetKind)
    {
        return packetKind switch
        {
            ...
            SelfImprovementPacketKinds.ApplyV0DryRunStarted => "Wevito wrote a self-improvement v0 rename dry-run record before any mutation.",
            SelfImprovementPacketKinds.ApplyV0DryRunCompleted => "Wevito finished writing the self-improvement v0 rename dry-run record without mutating the target file.",
            SelfImprovementPacketKinds.ApplyV0BackupWritten => "Wevito copied the self-improvement draft artifact to a backup path and recorded its sha256.",
            SelfImprovementPacketKinds.ApplyV0Applied => "Wevito atomically renamed a self-improvement artifact draft to its approved counterpart.",
            SelfImprovementPacketKinds.ApplyV0PostProofCompleted => "Wevito verified the self-improvement renamed artifact's sha256 and confirmed the original draft no longer exists.",
            SelfImprovementPacketKinds.ApplyV0RolledBack => "Wevito restored the original self-improvement draft artifact from its backup after a v0 rename failure.",
            SelfImprovementPacketKinds.ApplyV0Completed => "Wevito finished the self-improvement v0 rename apply sequence after every prior step succeeded.",
            SelfImprovementPacketKinds.ApplyV0ExplicitRollbackStarted => "Wevito started a self-improvement v0 explicit rollback from an approved artifact back to its draft form.",
            SelfImprovementPacketKinds.ApplyV0ExplicitRollbackCompleted => "Wevito completed a self-improvement v0 explicit rollback and verified the restored draft artifact.",
            SelfImprovementPacketKinds.ApplyV0ExplicitRollbackRefused => "Wevito refused a self-improvement v0 explicit rollback before or during the narrow rollback sequence.",
            SelfImprovementPacketKinds.MutationScopeAuditEvent => "Wevito recorded a mutation-scope audit event for a self-improvement file write under a declared scope.",
