# Generic Sprite Kit Smoke Sprite Pipeline Checklist
...
- [ ] Add an explicit resume queue for interrupted props

## Production Readiness

- [ ] Complete priority motion families across all required props and variant axes
- [ ] Complete secondary motion families across all required props and variant axes
- [ ] Complete special-case or interaction families across all required props and variant axes
