# Generic Sprite Smoke Sprite Pipeline Checklist
...
- [ ] Add an explicit resume queue for interrupted assets

## Production Readiness

- [ ] Complete priority motion families across all required assets and variant axes
- [ ] Complete secondary motion families across all required assets and variant axes
- [ ] Complete special-case or interaction families across all required assets and variant axes
